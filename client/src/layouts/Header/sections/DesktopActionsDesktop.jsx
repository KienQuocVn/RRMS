...
export default function DesktopActionsDesktop({
  username,
  avatar,
  motelId,
  tokenExists,
  ...
  return (
    ...
    >
      ...
      <Box sx={{ ...iconBtnStyle, px: 0 }}>
        <LanguageSelectDesktop toggleLanguage={toggleLanguage} currentLanguage={currentLanguage} />
      </Box>
