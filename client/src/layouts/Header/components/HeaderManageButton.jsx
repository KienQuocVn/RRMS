...
const HeaderManageButton = ({ motelId }) => {
  return (
    <Link className="aw__b1358qut primary r-normal medium w-bold i-left aw__h1gb9yk aw__p1hqie6d" to={`/quanlytro/${motelId}`} rel="nofollow">
...
export default HeaderManageButton
