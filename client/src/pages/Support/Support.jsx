        ...
        <div className="container">
          <div className="inner-container">
            ...
            <form
              ...
              <input data-format="int" type="hidden" className="form-control" name="province_id" value="79" />
              <input data-format="int" type="hidden" className="form-control" name="district_id" value="771" />
              <input data-format="int" type="hidden" className="form-control" name="category_id" value="1" />
              <div className="row" style={{ marginTop: '10px' }}>
                ...
                <div className="col-md-12" style={{ marginBottom: '10px' }}>
                  <div className="tag clearfix">
                    <span
                      ...
                      className="arena">
                      Tìm kiếm Phòng trọ, nhà trọ tại Khu vực{' '}
                      <b className="address-text">Quận 3, Hồ Chí Minh</b>
                    </span>
                  </div>
                </div>
                {/* content form */}
                ...
                <div
                    ...
                    <div>
                      <p style={{ fontSize: '12px', marginTop: '20px' }}>
                        <b>
                          ...
                          chủ nhà và chuyên viên hỗ trợ của RRMS{' '}
                          <b>(</b>
                  ...
                  <div style={{ display: 'flex' }}>
                    <div
                      id="btn-support-room"
                      className="btn-support-room pull-right"
