            ...
            {rows.map((row) => {
              ...
              return (
                <TableRow
                  ...
                  <TableCell sx={{ ...bodyCellSx, overflow: 'hidden' }}>
                    <Stack direction="row" spacing={1.25} alignItems="center" sx={{ overflow: 'hidden', width: '100%' }}>
                      {row.subjectType === 'Bài đăng' ? (
                        ...
                        <Avatar sx={{ width: 36, height: 36, bgcolor: '#E6F1FB', color: '#0C447C', fontSize: 13, flexShrink: 0 }}>{row.subjectTitle.slice(0, 2).toUpperCase()}</Avatar>
                      )}
                      <Typography sx={{ fontSize: 13, lineHeight: 1.4, textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }} title={row.subjectTitle}>
                        {row.subjectTitle}
                      </Typography>
                    </Stack>
                  </TableCell>
                  ...
                  <TableCell sx={{ ...bodyCellSx, overflow: 'hidden' }}>
                    <Typography sx={{ fontSize: 13, textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }} title={row.reason}>
                      {row.reason}
                    </Typography>
                  </TableCell>
                  <TableCell sx={bodyCellSx}>
                  ...
                  <TableCell sx={{ ...bodyCellSx, overflow: 'hidden' }}>
                    <Stack direction="row" spacing={1} alignItems="center" sx={{ overflow: 'hidden', width: '100%' }}>
                      <Avatar sx={{ width: 24, height: 24, fontSize: 11, bgcolor: '#DBEAFE', color: '#1D4ED8', flexShrink: 0 }}>{row.lastReporter.initials}</Avatar>
                      <Typography sx={{ fontSize: 13, textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }} title={row.lastReporter.name}>{row.lastReporter.name}</Typography>
                    </Stack>
                  </TableCell>
