    ...
    <Box sx={{ mb: 2 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2, flexWrap: 'wrap', gap: 2 }}>
        ...
        <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
          <IconButton sx={{ bgcolor: '#f44336', color: 'white', '&:hover': { bgcolor: '#d32f2f' }, width: 36, height: 36 }}>
            <PlayArrowIcon />
          </IconButton>
          
          <IconButton onClick={onAddRoom} sx={{ bgcolor: '#20a9e7', color: 'white', '&:hover': { bgcolor: '#2b7ed7' }, width: 36, height: 36 }}>
            <AddIcon />
          </IconButton>
      ...
      {/* Filter Row */}
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', bgcolor: '#fafafa', p: 1, borderRadius: 1, border: '1px solid #eeeeee', flexWrap: 'wrap', gap: 2 }}>
