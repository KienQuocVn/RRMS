...
const buildEarlyTerminationTask = (contract, terminateDateStr) => {
  ...
  const remainingLabel = remainingMonths > 0 ? `${remainingMonths} tháng` : 'dưới 1 tháng'
      ...
      <DialogContent sx={{ py: 3 }}>
        ...
        <Alert severity="info" sx={{ mb: 4, '& .MuiAlert-icon': { color: '#20a9e7' } }}>
          ...
          <Box component="ul" sx={{ m: 0, pl: 2, '& li': { mb: 0.5 } }}>
            <li>
              Kết thúc hợp đồng là hành động kết thúc khi khách muốn chuyển đi. Sau khi kết thúc bạn có thể Lập hợp đồng
              cho khách mới
            </li>
            <li>
              Các thông tin như <b>Khách thuê, hợp đồng cũ</b> sẽ xóa bỏ để sẵn sàng cho hợp đồng mới.
            </li>
          </Box>
        </Alert>
        ...
        {showEarlyTerminationTask && earlyTerminationInfo && (
          <Alert severity="warning" sx={{ mb: 3 }}>
            ...
            {earlyTerminationInfo.endDate
              ...
              : ''}
            . Kết thúc trước hạn có thể phát sinh nghĩa vụ đền hợp đồng — vui lòng thông báo và thống nhất với khách
            thuê/chủ trọ trước khi tiếp tục.
          </Alert>
        )}
        ...
        <Box>
          <Typography
            variant="h6"
            sx={{ textAlign: 'center', mb: 2, fontWeight: 'bold', color: '#444', fontSize: '1.1rem' }}>
            ...
            <Box
              ...
              <Box sx={{ mr: 2, display: 'flex', alignItems: 'center' }}>
                <Box
                  sx={{
                    ...
                    bgcolor: task.completed ? '#20a9e722' : task.isEarlyTermination ? '#ffe0b2' : '#fff3e0',
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Button
                  ...
                  {task.completed
                    ? 'Đã hoàn thành'
                    : task.isEarlyTermination
                      ? 'Đã xác nhận và lưu ý'
