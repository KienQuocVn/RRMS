...
const InvoiceManager = lazy(() => import('../pages/admin/NavContentAdmin/InvoiceManage/InvoiceManager'))
const ServiceManager = lazy(() => import('../pages/admin/NavContentAdmin/ServiceManage/ServiceManager'))
const AssetManager = lazy(() => import('../pages/admin/NavContentAdmin/DeviceManage/AssetManager'))
...
const AdminRoutes = ({ auth, motel }) => {
  ...
  return (
    <>
      ...
      <Route
        path="/tai-khoan"
        element={<ManagerMyAccount TaiKhoan={username} setIsAdmin={setIsAdmin} motels={motels} setmotels={setMotels} />}
      />
      <Route
        path="/tai-khoan/:motelId"
        element={<ManagerMyAccount TaiKhoan={username} setIsAdmin={setIsAdmin} motels={motels} setmotels={setMotels} />}
      />
