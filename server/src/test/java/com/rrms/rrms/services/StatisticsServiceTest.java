...
public class StatisticsServiceTest {
    ...
    public void testGetTotalTenants() {
        ...
        assertEquals(
                expectedCount, actualCount, "Tá»•ng sá»‘ ngÆ°á»i thuÃª khÃ´ng khá»›p vá»›i giÃ¡ trá»‹ mong Ä‘á»£i.");
    }
    ...
    public void testGetTotalMotels() {
        ...
        assertEquals(expectedCount, actualCount, "Tá»•ng sá»‘ nhÃ  trá» khÃ´ng khá»›p vá»›i giÃ¡ trá»‹ mong Ä‘á»£i.");
    }
