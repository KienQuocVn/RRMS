    ...
    <View style={styles.container}>
      ...
      <View style={styles.sectionHeader}>
        ...
        <View>
          ...
          <Text style={styles.sectionSubtitle}>Tình trạng phòng đang thuê trong hệ thống</Text>
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.bannerContainer}>
        <View style={styles.bannerContent}>
          <Text style={styles.bannerTitle}>
            Có <Text style={styles.bannerHighlight}>0 hợp đồng</Text> đang kết nối
          </Text>
          <Text style={styles.bannerDesc}>
            Báo hóa đơn tự động, thanh toán tự động, nhập thông tin online...
          </Text>
          <View style={styles.bannerButton}>
            <Text style={styles.bannerButtonText}>Giảm 10% phí khi trên 50% kết nối</Text>
          </View>
        </View>
        <Ionicons name="bag-handle" size={60} color={Colors.error} style={styles.bannerIcon} />
      </TouchableOpacity>
      ...
      <View style={styles.sectionHeader}>
        ...
        <View>
          ...
          <Text style={styles.sectionSubtitle}>Thống kê các loại tiền bạn đang quản lý</Text>
        </View>
      </View>
    ...
    <TouchableOpacity style={styles.statCard} onPress={onPress}>
      <View style={styles.statTop}>
        <View style={styles.statDetail}>
          ...
          <View style={[styles.percentBadge, { backgroundColor: percentColor + '15' }]}>
