...
const INITIAL_SERVICES: ServiceItem[] = [
  { id: 'electric', title: 'Dịch vụ điện', mode: 'Tính theo đồng hồ (phổ biến)' },
  { id: 'water', title: 'Dịch vụ nước', mode: 'Tính theo đồng hồ (phổ biến)' },
  { id: 'trash', title: 'Dịch vụ rác', mode: 'Miễn phí tiền điện/không sử dụng' },
  { id: 'internet', title: 'Dịch vụ internet/mạng', mode: 'Miễn phí tiền điện/không sử dụng' },
];
...
const FEATURE_ITEMS: FeatureItem[] = [
  {
    ...
    description: 'Tạo & kết nối dễ dàng, hóa đơn tự động, thanh toán online, ký hợp đồng online....',
...
export default function AddBuildingServicesScreen() {
  ...
  const addressSummary = [address.detail, address.ward, address.district, address.city]
    .filter(Boolean)
    .join(', ');

  const handleSave = () => {
    Alert.alert('Đã lưu thông tin', 'Thiết lập dịch vụ và tính năng đã được cập nhật trong giao diện mẫu.');
  };
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {services.length === 0 ? (
            <View style={styles.emptyBox}>
              <Text style={styles.emptyText}>Bạn đã gỡ toàn bộ dịch vụ mặc định.</Text>
            </View>
          ) : null}
        </View>
            ...
            <View key={item.id}>
              <View style={styles.featureRow}>
                ...
                <View style={styles.featureContent}>
                  ...
                  {item.highlight ? (
                    <Text style={styles.featureHighlight}>{item.highlight}</Text>
                  ) : null}
                </View>
              ...
              {index < FEATURE_ITEMS.length - 1 && <View style={styles.divider} />}
            </View>
          ))}
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            ...
            <Text style={styles.addressActionText}>Thêm địa chỉ & vị trí trên bản đồ</Text>
          </TouchableOpacity>
          ...
          {addressSummary ? (
            <View style={styles.addressSummaryCard}>
              ...
              <View style={styles.addressSummaryText}>
                ...
                {address.mapLabel ? (
                  <Text style={styles.addressSummaryMeta}>{address.mapLabel}</Text>
                ) : null}
              </View>
            </View>
          ) : null}
