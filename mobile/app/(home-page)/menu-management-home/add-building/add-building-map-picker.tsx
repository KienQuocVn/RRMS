      ...
      >
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.headerSubtitle}>
            Ghim điểm để khách tìm kiếm phòng dễ dàng hơn
          </Text>
        </View>
      </View>
      ...
      <View style={styles.mapWrapper}>
        {loadingCenter || !baseCenter ? (
          <View style={styles.mapLoading}>
            <ActivityIndicator size="small" color="#20a9e7" />
          ...
          <>
            ...
            >
              <Ionicons name="navigate" size={24} color="#20a9e7" />
            </TouchableOpacity>
            ...
            >
              {selectedCoords ? (
                <Text style={styles.coordsText}>
                  {selectedCoords.latitude.toFixed(15)},{" "}
                  {selectedCoords.longitude.toFixed(15)}
                </Text>
              ) : (
              ...
              <View style={styles.actionRow}>
                ...
                >
                  <Text style={styles.confirmButtonFloatText}>
                    Xác định vị trí
                  </Text>
                </TouchableOpacity>
              </View>
