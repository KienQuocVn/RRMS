...
const BASIC_SETTINGS: SettingItem[] = [
  {
    ...
    route: '/rental-settings/room-groups',
  },
  {
    id: 'price-increase',
    icon: 'cash-outline',
    ...
    route: '/rental-settings/price-increase',
  },
  {
    id: 'income-expense',
    ...
    route: '/rental-settings/income-expense',
  },
  {
    id: 'toggle-features',
    ...
    route: '/rental-settings/toggle-features',
    hideDivider: true,
  },
];
...
const ADVANCED_SETTINGS: SettingItem[] = [
  {
    ...
    route: '/rental-settings/rules-settings',
  },
  {
    id: 'amenities',
    icon: 'apps-outline',
    ...
    route: '/rental-settings/amenities-settings',
    hideDivider: true,
  },
];
