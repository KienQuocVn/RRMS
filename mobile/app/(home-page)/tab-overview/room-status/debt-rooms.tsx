/**
 * DebtRoomsScreen - Màn hình thống kê phòng đang nợ tiền
 * Dùng cho: Quản lý danh sách phòng hiện tại đang nợ tiền thuê hoặc hóa đơn dịch vụ quá hạn
 */
...
export default function DebtRoomsScreen() {
  ...
  const Header = () => (
    ...
    >
      ...
      <Text style={styles.headerTitle}>Thống kê phòng đang nợ tiền</Text>
    </View>
  );
        ...
        >
          ...
          <View style={{ alignItems: "flex-end", gap: 6 }}>
            <View style={styles.statusBadge}>
              ...
              <Text style={styles.statusText}>Đang nợ tiền</Text>
            </View>
            <View style={styles.statusBadge}>
              <View style={[styles.dot, { backgroundColor: "#F44336" }]} />
              <Text style={styles.statusText}>Quá hạn thanh toán</Text>
            </View>
          </View>
        </View>
      </View>
