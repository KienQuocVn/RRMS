/**
 * EmptyRoomsScreen - Màn hình thống kê phòng đang trống
 * Dùng cho: Quản lý danh sách phòng đang trống hoàn toàn trong hệ thống
 */
...
export default function EmptyRoomsScreen() {
  ...
  const Header = () => (
    ...
    >
      ...
      <Text style={styles.headerTitle}>Thống kê phòng đang trống</Text>
    </View>
  );
