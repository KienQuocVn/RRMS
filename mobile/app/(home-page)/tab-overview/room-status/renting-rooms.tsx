/**
 * RentingRoomsScreen - Màn hình thống kê phòng đang thuê (đang ở)
 * Dùng cho: Quản lý danh sách các phòng hiện đang có khách ở trong hệ thống
 */
...
export default function RentingRoomsScreen() {
  ...
  const Header = () => (
    ...
    >
      ...
      <Text style={styles.headerTitle}>Thống kê phòng đang ở</Text>
    </View>
  );
