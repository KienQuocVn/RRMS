/**
 * ReportedLeavingRoomsScreen - Màn hình thống kê phòng báo rời đi
 * Dùng cho: Quản lý danh sách phòng đã có khách báo kết thúc hợp đồng và sắp trả phòng
 */
...
export default function ReportedLeavingRoomsScreen() {
        ...
        >
          ...
          <View style={{ alignItems: "flex-end", gap: 6 }}>
            <View style={styles.statusBadge}>
              ...
              <Text style={styles.statusText}>Đã báo kết thúc hợp đồng</Text>
            </View>
            <View style={styles.statusBadge}>
              <View style={[styles.dot, { backgroundColor: "#FF9800" }]} />
              <Text style={styles.statusText}>Chưa thu tiền</Text>
            </View>
          </View>
        </View>
      </View>
