    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerTitleWrap}>
          ...
          <Text style={styles.headerSubtitle}>
            Môi giới tìm khách chuyên nghiệp
          </Text>
        </View>
        <TouchableOpacity
      ...
      <View style={styles.emptyStateContainer}>
          ...
          <View style={styles.illustrationCard}>
            ...
            <View
              style={[
                ...
                { backgroundColor: "#FF9800", top: 8, left: 8 },
              ]}
            />
            <View
              style={[
                styles.illustrationDot,
                { backgroundColor: "#E91E63", bottom: 12, left: 16 },
              ]}
            />
          </View>
        ...
        <Text style={styles.emptyTitle}>
          Thất thoát doanh thu vì phòng trống
        </Text>
        <Text style={styles.emptyDesc}>
          Đừng lo bạn chỉ cần booking chuyên viên chúng tôi sẽ hỗ trợ bạn lắp
          phòng với độ phủ cao và tốc độ lắp phòng nhanh LOIZIDO đã hỗ trợ các
          chủ nhà lắp phòng nhanh chóng
        </Text>
