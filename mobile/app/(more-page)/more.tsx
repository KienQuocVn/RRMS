...
const MORE_ITEMS: MoreMenuItem[] = [
  {
    id: "company",
    icon: "globe-outline",
    label: "Công ty, nhóm - Q.lý thành viên",
    subLabel: "Thêm tài khoản cùng sử dụng phần mềm",
    route: "/settings/company-management",
  },
  {
    id: "rrms-plus",
    icon: "gift-outline",
    label: "RRMS Plus+",
    badge: { text: "PRO", bg: "#E67E22" },
  },
  {
    id: "brand",
    icon: "bookmark-outline",
    label: "Cài đặt thương hiệu tòa nhà",
    subLabel: "Cài đặt logo thương hiệu, website...",
    route: "/settings/brand-settings",
  },
  {
    id: "owner-info",
    icon: "person-outline",
    label: "Thông tin đại diện chủ tòa nhà",
    subLabel: "Thông tin dùng làm mẫu hợp đồng, tạm trú cho khách thuê.",
    route: "/settings/representative-info",
  },
  {
    id: "digital-signature",
    icon: "pencil-outline",
    label: "Cài đặt chữ ký số",
    subLabel: "Dùng để thiết lập chữ ký hợp đồng, tạm trú cho khách thuê.",
    badge: { text: "Mới", bg: "#27AE60" },
    route: "/settings/digital-signature",
  },
  {
    id: "change-password",
    icon: "key-outline",
  ...
  },
  {
    ...
    subLabel: "Bạn đang đăng nhập bằng normal",
    badge: { text: "Gấp", bg: "#E74C3C" },
    route: "/settings/link-phone",
  },
  {
    id: "permissions",
    icon: "shield-outline",
    label: "Cài đặt quyền phần mềm",
    subLabel: "Cung cấp quyền giúp phần mềm hoạt động",
  ...
  },
  {
    ...
    label: "Chia sẻ APP khách thuê",
    subLabel:
      "Khách kết nối với bạn, nhận hóa đơn tự động & nhiều tiện ích khác",
  },
  {
    id: "rate-app",
    icon: "cube-outline",
    label: "Đánh giá phần mềm",
    subLabel: "Một đánh giá tốt giúp RRMS thêm động lực hoàn thiện",
    stars: true,
  },
  {
    id: "app-info",
  ...
  },
  {
    ...
    rightText: "Version: 3.0.6 / 6",
    rightSubText: "production",
    hideChevron: true,
  },
  {
    id: "os",
      ...
      >
          ...
          >
            ...
            <View style={styles.profileInfo}>
              <Text style={styles.profileName}>
                Xin chào!{" "}
                {user?.fullName || user?.fullname || user?.username || "Bạn"}
              </Text>
        ...
        <View style={styles.socialCard}>
          ...
          <View style={styles.socialGrid}>
            <TouchableOpacity
              style={[styles.socialBtn, { borderColor: "#E74C3C" }]}
            >
              <Ionicons name="logo-youtube" size={18} color="#E74C3C" />
              <Text style={[styles.socialBtnText, { color: "#E74C3C" }]}>
                Youtube
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.socialBtn, { borderColor: "#3B5998" }]}
            >
              <Ionicons name="logo-facebook" size={18} color="#3B5998" />
              <Text style={[styles.socialBtnText, { color: "#3B5998" }]}>
                Facebook
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              ...
              <Text style={[styles.socialBtnText, { color: "#000000" }]}>
                Tiktok
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.socialBtn, { borderColor: "#0084FF" }]}
            >
              <View style={styles.zaloIconWrapper}>
                <Text style={styles.zaloIconText}>Zalo</Text>
              </View>
              <Text style={[styles.socialBtnText, { color: "#0084FF" }]}>
                ZALO
              </Text>
            </TouchableOpacity>
          </View>
