    ...
    >
      ...
      <View style={styles.headerTitleWrap}>
        ...
        <Text style={styles.headerSub}>
          Sử dụng dễ dàng hơn với trung tâm trợ giúp
        </Text>
      </View>
    </View>
  );
  ...
  const VideoItem = ({ title, description }: any) => (
    <View style={styles.videoItem}>
      <View style={styles.videoThumbnail}>
        <Image
          source={{
            uri: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&q=80&w=150",
          }}
      ...
      >
        ...
        <View style={styles.banner}>
          ...
          <View style={styles.bannerSubWrap}>
            <Text style={styles.bannerSub}>
              Chuyên viên luôn sẵn sàng hỗ trợ bạn 24/7
            </Text>
          </View>
        </View>
        ...
        <View style={styles.optionsList}>
          <TouchableOpacity style={styles.optionItem}>
            ...
            <Text style={styles.optionText}>
              Demo - Hướng dẫn phần mềm online
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionItem}>
            <Ionicons
          ...
          <View style={styles.optionItem}>
            ...
            <View style={styles.optionInfo}>
              ...
              <Text style={styles.optionDesc}>
                Là icon được hiển thị ở các màn hình để giúp bạn hiểu phần mềm
              </Text>
            </View>
            <Switch
        ...
        <View style={styles.videoSection}>
          ...
          <Text style={styles.sectionSub}>
            Xem danh sách video hướng dẫn để làm quen phần mềm
          </Text>
